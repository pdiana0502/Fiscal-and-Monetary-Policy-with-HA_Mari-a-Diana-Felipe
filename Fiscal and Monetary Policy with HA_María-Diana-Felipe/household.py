...
# Change: a2 (sq of assets) as new heterogenous output
@sj.het(
    exogenous='Pi',
    policy='a',
    backward='Va',
...
def hh_raw(Va_p, a_grid, y, r, beta, eis):
    ...
    # NUEVO: cuadrado de activos (para desigualdad)
    a2 = a**2

    # orden: primero Va (backward), luego todos los outputs heterogéneos
    return Va, a, c, a2
